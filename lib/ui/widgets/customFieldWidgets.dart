        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: Utils.getTranslatedLabel(enterTextKey),
            ),
          ),
        ),
        const SizedBox(height: 15),
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              value: controller.text.isNotEmpty && options.contains(controller.text)
                  ? controller.text
                  : null,
              hint: CustomTextContainer(textKey: selectOptionKey),
              isExpanded: true,
              ...
              children: [
                ...
                Expanded(
                  child: CustomTextContainer(
                    textKey: hasUploadedFile
                        ? newFileSelectedWillBeUploadedOnSaveKey
                        : fileAlreadyUploadedKey,
                    style: TextStyle(
                      color: hasUploadedFile ? Colors.green : Colors.blue,
                      fontSize: 12,
                      fontWeight: FontWeight.w500,
                ...
                if (onFileUpload != null)
                  TextButton.icon(
                    ...
                    label: CustomTextContainer(textKey: changeKey),
