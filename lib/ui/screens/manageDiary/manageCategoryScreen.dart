...
class _ManageCategoryScreenState extends State<ManageCategoryScreen> {
  ...
  void _onDeleteCategory(DiaryCategory category) {
    ...
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        title: CustomTextContainer(textKey: deleteCategoryKey),
        content: CustomTextContainer(textKey: areYouSureToDeleteCategoryKey),
        actions: [
          TextButton(
            onPressed: () => Navigator.of(dialogContext).pop(),
            child: CustomTextContainer(textKey: cancelKey),
          ),
          TextButton(
            onPressed: () {
  ...
  Widget _buildCategoryList(List<DiaryCategory> categories) {
    if (categories.isEmpty) {
      return noDataContainer(titleKey: noCategoryFoundKey);
    }
