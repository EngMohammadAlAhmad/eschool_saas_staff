  ...
  static Widget getRouteInstance() {
    ...
    if (resolvedPlan == null) {
      ...
      return const Scaffold(
        body: Center(child: CustomTextContainer(textKey: noPlanDataAvailableKey)),
      );
    }
              ...
              listener: (context, state) {
                if (state is TransportEnrollmentSubmissionSuccess) {
                  ...
                  Get.offNamed(
                    ...
                    arguments: {
                      'message': routeChangeRequestedSuccessfullyKey,
                      'userId': userId,
                    },
                  );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextContainer(
            textKey:
                '${Utils.getTranslatedLabel(yourPickupKey)} : $pickupInfo${pickupTime != null ? ' | $pickupTime' : ''}',
            style: const TextStyle(
              fontSize: 12,
              fontWeight: FontWeight.w500,
              color: Color(0xFF212121),
