...
class _LiveRouteBottomSheetState extends State<LiveRouteBottomSheet> {
  ...
  void _fetchLiveRoute() {
    ...
    if (userId > 0) {
      ...
      Utils.showSnackBar(
        context: context,
        message: userNotAuthenticatedPleaseLoginAgainKey,
                      ...
                      if (state is LiveRouteFetchSuccess) {
                        ...
                        if (state.wasRefresh) {
                          if (cubit.hasActiveTrip()) {
                            ...
                            Utils.showSnackBar(
                              context: context,
                              message: liveRouteDataRefreshedSuccessfullyKey,
                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CustomTextContainer(
                                textKey: loadingLiveRouteDataKey,
                                style: TextStyle(
                                  fontSize: 16,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                CustomTextContainer(
                  textKey:
                      "${Utils.getTranslatedLabel(currentlyAtKey)} ${_getCurrentLocation(trip)}",
      ...
      children: [
        Column(
          ...
          children: [
            CustomTextContainer(
              textKey:
                  "${Utils.getTranslatedLabel(busNoKey)} : ${trip.vehicle.number}",
              style: const TextStyle(
                fontSize: 16,
                fontWeight: FontWeight.w600,
                color: Colors.black,
