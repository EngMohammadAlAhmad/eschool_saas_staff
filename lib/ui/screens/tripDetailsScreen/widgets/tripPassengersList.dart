...
class _TripPassengersListState extends State<TripPassengersList> {
  ...
  String _getAttendanceText(PassengerStatus status) {
    switch (status) {
      case PassengerStatus.present:
        return presentSymbolKey;
      case PassengerStatus.absent:
        return absentSymbolKey;
      case PassengerStatus.notMarked:
        return "";
    }
  }
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            const SizedBox(width: 8),
            CustomTextContainer(
              textKey: "$presentCount ${Utils.getTranslatedLabel(presentSymbolKey)}, $absentCount ${Utils.getTranslatedLabel(absentSymbolKey)}",
              style: TextStyle(
                fontSize: 12,
                fontWeight: FontWeight.w600,
                color: Colors.green.shade700,
